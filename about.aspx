            ...
            <div class="inner-sec py-lg-5 py-3">
                <div class="row">
                    <div class="col-lg-6 about-img">
                        <img class="img-fluid" src="clientsrc/images/g1.jpg" alt="">
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                            <img src="clientsrc/images/te1.jpg" class="img-fluid" alt="img">
                    ...
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                            <img src="clientsrc/images/te2.jpg" class="img-fluid" alt="img">
                            <div class="view-caption">
                    ...
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                            <img src="clientsrc/images/te3.jpg" class="img-fluid" alt="img">
                            <div class="view-caption">
                                 <ul class="social-icons justify-conten-center">
                                    <li class="mr-1"><a href="#"><span class="fa fa-facebook"></span></a></li>
                                    <li class="mx-1"><a href="#"><span class="fa fa-twitter"></span></a></li>
                    ...
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                            <img src="clientsrc/images/te4.jpg" class="img-fluid" alt="img">
                            <div class="view-caption">
                                 <ul class="social-icons justify-conten-center">
                                    <li class="mr-1"><a href="#"><span class="fa fa-facebook"></span></a></li>
                                    <li class="mx-1"><a href="#"><span class="fa fa-twitter"></span></a></li>
