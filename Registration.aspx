    ...
    <div class="reg-w3">
        <div class="w3layouts-main">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ErrorMessage="enter name" ControlToValidate="TextBox1" 
                ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
            
            <asp:TextBox ID="TextBox2" runat="server" class="ggg" name="Email" placeholder="E-MAIL" ></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ErrorMessage="enter email" Display="Dynamic" ControlToValidate="TextBox2" 
                ForeColor="Red"></asp:RequiredFieldValidator>
           
           
            
            <asp:TextBox ID="TextBox3" runat="server" class="ggg" name="Phone" placeholder="PHONE"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                ErrorMessage="enter phone" ControlToValidate="TextBox3" Display="Dynamic" 
                ForeColor="Red"></asp:RequiredFieldValidator>

         
            <asp:TextBox ID="TextBox4" runat="server" class="ggg" name="Password" placeholder="PASSWORD" TextMode="Password"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                ErrorMessage="enter password" ControlToValidate="TextBox4" Display="Dynamic" 
                ForeColor="Red"></asp:RequiredFieldValidator>
            
            <asp:TextBox ID="TextBox5" runat="server" class="ggg" placeholder="confirm PASSWORD" TextMode="Password"></asp:TextBox>
            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                ErrorMessage="password is not mach" ControlToCompare="TextBox4" 
                ControlToValidate="TextBox5" Display="Dynamic" ForeColor="Red"></asp:CompareValidator>
